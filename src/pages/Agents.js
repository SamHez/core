...
function Agents() {
  ...
  useEffect(() => {
    document.title = "Agents | Core Insurance Management";
    getAgents();
      ...
      <header className="tw-mx-5 tw-py-5">
        <div className="nk-block-between">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Agents</h1>
            <p className="tw-text-sm tw-text-gray-500">Managing Agents</p>
          </div>
