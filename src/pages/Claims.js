...
export default function Claims({ parent_container }) {
  ...
  useEffect(() => {
    document.title = "Claims | Core Insurance Management";
    getClaims();
    ...
    <header className="tw-mx-5 tw-py-5">
        <div className="nk-block-between">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Claims</h1>
            <p className="tw-text-sm tw-text-gray-500">Claims Notifications</p>
          </div>
      ...
      <Header title="Claims" subtitle="Claims Notifications" />
