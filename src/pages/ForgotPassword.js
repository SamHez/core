...
import logoVertical from "../assets/imgs/core-ll.png";
...
function ForgotPassword() {
  ...
  useEffect(() => {
    ...
    document.title = "Forgot Password | Core Insurance Management";
  });
  ...
  return (
    <div className="auth-wrapper">
     <div className="auth-overlay">
      <ToastContainer />
      <form onSubmit={handleResetPassword} className="tw-text-gray-500 form-forgot">
      <center><img src={logoVertical} width={120} alt="CORE" /></center>
        <h2 className="tw-mb-2 tw-text-lg">Forgot Password?</h2>
        <p id="enter">Enter your e-mail address to reset your password</p><br/>
