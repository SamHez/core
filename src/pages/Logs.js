...
function Logs({parent_container}) {
    ...
    useEffect(() => {document.title = 'Log Trails | Core Insurance Management'; getLogs()}, [])
        ...
        <div className='components'>
            ...
            <header className="tw-mx-5 tw-py-5">
                ...
                <div className="header-txt">
                    <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Logs</h1>
                    <p className="tw-text-sm tw-text-gray-500">User Log Trails</p>
                </div>
