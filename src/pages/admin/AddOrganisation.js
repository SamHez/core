...
export default function AddOrganisation({parent_container}) {
    ...
    useEffect(() => { document.title = 'Add Organisations | Core Insurance Management'}, [])
    ...
    return (
        ...
        <div className="nk-block-between">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Add Organisations</h1>
            <p className="tw-text-sm tw-text-gray-500">Add A New Organisation</p>
          </div>
        </div>
        </header>
