...
export default function Organisations({ parent_container }) {
  ...
  useEffect(() => {
    document.title = "Organisations | Core Insurance Management";
    getOrganisations();
  }, []);
      ...
      <header className="tw-mx-5 tw-py-5">
        <div className="nk-block-between">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Organisations</h1>
            <p className="tw-text-sm tw-text-gray-500">View Company Details</p>
          </div>

          <div id="add_client_group">
            <div></div>
            <Link to="/admin/add-organisations"><button className="btn cta m-3">Add Organisation</button></Link>
          </div>
        </div>
      </header>
