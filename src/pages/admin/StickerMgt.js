...
export default function StickerMgt({ parent_container }) {
  useEffect(() => {
    document.title = "Stickers Management | Core Insurance Management";
    getStickerRange();
  }, []);
  ...
  return (
    <div className="components">
      ...
      <header className="tw-mx-5 tw-py-5">
        <div className="nk-block-between pdbtm">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Sticker No. Management</h1>
            <p className="tw-text-sm tw-text-gray-500">Managing Sticker Numbers</p>
          </div>
