...
function Admins({ parent_container }) {
  useEffect(() => {
    document.title = "Admins | Core Insurance Management";
    getAdmins();
  }, []);
      ...
      <header className="tw-mx-5 tw-py-5">
        <div className="nk-block-between">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">Admins</h1>
            <p className="tw-text-sm tw-text-gray-500">Managing Admins</p>
          </div>

          <div id="add_client_group">
            <div></div>
            <Link to="/superadmin/add-admin" className="classic"><button className="btn cta m-2">Add Admin</button></Link>
          </div>
        </div>
      </header>
