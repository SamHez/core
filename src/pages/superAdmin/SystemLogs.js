...
function SystemLogs() {
  useEffect(() => {
    document.title = "System Logs | Core Insurance Management";
    getLogs();
    return () => {};
  }, []);
      ...
      <header className="tw-mx-5 tw-py-5">
        <div className="nk-block-between">
          <div className="header-txt">
            <h1 className="tw-text-lg md:tw-text-4xl tw-font-bold">System Logs</h1>
            <p className="tw-text-sm tw-text-gray-500">Managing Logs</p>
          </div>
